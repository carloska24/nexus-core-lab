...
// MOCK: pool snapshot/warm-up are not integrated in Gate 2.
function Pool() { return <article className="panel analytic pool"><div className="panel-head"><div className="head-title"><span className="head-icon"><Server/></span><div><h2>IP Pool Usage <em className="mock-tag">mock</em></h2><p>10.45.0.0/16 (Virtual Network)</p></div></div></div><div className="pool-stat"><b>17 / 256 IPs in use</b><b>6.6%</b></div><div className="progress"><i/></div><div className="pool-legend"><span><i/>In Use (17)</span><span><i/>Available (239)</span></div><div className="warm"><Check/><div><b>IPPool warm-up completed</b><small>1 active session IP(s) pre-allocated</small></div></div></article> }
